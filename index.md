...
| ------------- | ------------- | ------------- |
| 🦟 [Yellow Fever Vaccinations](https://github.com/nodar-k/Code-Portfolio/blob/94ad51ec0e894d8cd95134b2ac9bf915e8d26abb/codes/Yellow-Fever-Models.Rmd)| Our team created a multi-host SEIR model to simulate a YFV outbreak and the impacts of vaccination on short and long-term epidemic transmission dynamics. My role specifically was conceptualizing the mathematical models and all the coding in R |  R |
| 💉 [Delayed Vaccinations](https://github.com/nodar-k/Code-Portfolio/blob/94ad51ec0e894d8cd95134b2ac9bf915e8d26abb/codes/VaxStudy.sas)  | Ongoing ecological study to understand the impacts of delayed vaccinations in low and lower-middle income countries. I am responsible for collaborating on the study design and leading the data analysis and coding. Part of the project is also being completed in R. This portion is just one piece of the larger code. | SAS |
| 🏥 [NYC COVID-19 Hospitalizations](https://github.com/nodar-k/Code-Portfolio/blob/94ad51ec0e894d8cd95134b2ac9bf915e8d26abb/codes/NYC-COVID-Hospitalizations.sas)  | One part of a larger midterm where we looked at NYC COVID-19 hospitalizations. The data was pulled directly from the NYC Health GitHub | SAS  |
| 🤧 [Ebola Transmission Dynamics](https://github.com/nodar-k/Code-Portfolio/blob/94ad51ec0e894d8cd95134b2ac9bf915e8d26abb/codes/Ebola-Model.R)  | Simulated the transmission dynamics of the 2014 West African Ebola Outbreak overall and by countries affected (Guinea, Liberia, and Sierra Leone | R  |
| 💉 [Vaccine Uptake and Insurance Coverage](https://github.com/nodar-k/Code-Portfolio/blob/94ad51ec0e894d8cd95134b2ac9bf915e8d26abb/codes/Vax-Uptake-NHANES.sas)  | Looking at the impact of insurance coverage on Hep A, Hep B, and HPV vaccine uptake using two cycles of NHANES. I primarily did all the analysis and the first run of the SAS code and annotations. | SAS  |
| 💊 [PrEP Uptake among cis-gender Black women](https://github.com/nodar-k/Code-Portfolio/blob/94ad51ec0e894d8cd95134b2ac9bf915e8d26abb/codes/PrepUptake-MetaAnalysis.R)  | A systematic review and proportional meta-analysis on observational studies looking at knowledge of and willingness to uptake PrEP among cis-gender Black women in America. My role was to code and run the meta-analysis. | R |
...
The formula for basic IDW interpolation of $i^th$ area $x$:

```math
x_i=(1/d_1  x_1+1/d_2  x_2+⋯1/d_n  x_n)/(1/d_1 +1/d_2 +⋯1/d_n )
```

Where $1/d_1$  is the inverse of the distance from point 1 to the predicted $i^th$ area and $x_1$ is the observed density at point 1. 

In comparison, the regression model predicts density based on several ecological predictors. The regression model is a combination of a logistic regression model predicting whether the observation was sampled from the point mass at zero. The second part of the model estimates the expected value based on the predictors (i.e., $β ̂_n x_n$)

```math
Y ̂=(P ̂ )(0)+(1-P ̂ )[exp⁡(β ̂_0+β ̂_1 x_1+β ̂_2 x_2+⋯)]
P ̂=exp⁡(γ ̂_0+γ ̂_1 z_1+γ ̂_2 z_2+⋯)/[1+exp⁡(γ ̂_0+γ ̂_1 z_1+γ ̂_2 z_2+⋯)]
```
...
4. Kipshidze NN, Kipshidze N, Horn JB. Transcatheter Endoluminal Phototherapy as a Possible Adjunct Treatment for Patients with COVID-19. Photobiomodul Photomed Laser Surg. 2020;38(10):579-580.
5. Kipshidze N, Iversen P, Porter TR, Kipshidze N, Siddiqui F, Dangas G, Jawed F. Targeted, Site-Specific, Delivery Vehicles of Therapeutics for COVID-19 Patients. Brief Review. Clin Appl Thromb Hemost. 2020;26:1076029620954911.
6. Kipshidze N, Yeo N, Kipshidze N. Photodynamic and sonodynamic therapy of acute hypoxemic respiratory failure in patients with COVID-19. Nature Photonics. 2020.
7. Kipshidze N, Dangas G, White CJ, Kipshidze N, Siddiqui F, Lattimer C, Carter C, Fareed J. Viral Coagulopathy in Patients With COVID-19: Treatment and Care. Clin Appl Thromb Hemost. 2020;26:1076029620936776.
8. Kipshidze N, Chekanov VS, Kipshidze N, Reddy VY, Dangas G. Transpulmonary electrotherapy for reduction of lung viral load of SARS-CoV-2 in patients with COVID-19. Med Hypotheses. 2020;143:110071.
9. Kipshidze N., Kipshidze N. Catheter-Based, Local Therapy in SARS-CoV-2 Patients? BMJ 2020. 
